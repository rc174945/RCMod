...
namespace UI
{
    class QuestAchievmentsPanel : QuestCategoryPanel
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            Transform header = ElementFactory.InstantiateAndBind(SinglePanel, "AchievmentHeader").transform;
            ...
            popup.CreateAchievmentDropdowns(header.Find("LeftPanel"));
            AchievmentCount count = GameProgressManager.GameProgress.Achievment.GetAchievmentCount();
