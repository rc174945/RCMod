namespace Settings
{
    class InteractionInputSettings: SaveableSettingsContainer
    {
        ...
        public KeybindSetting CannonSlow = new KeybindSetting(new string[] { "LeftShift", "None" });
        public KeybindSetting CannonFire = new KeybindSetting(new string[] { "Q", "None" });
        // public KeybindSetting OpenItemMenu = new KeybindSetting(new string[] { "F", "None" });
